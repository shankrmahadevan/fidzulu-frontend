  ...
  @Input() products: Product[] = [
    {
      ...
      product_description:
        'A collection of safari animal figures for pretend play and learning about wildlife.',
...

    {
      ...
      product_description:
        'An interactive fishing game for kids to experience the excitement of fishing.',
...

    {
      ...
      product_description:
        'A mini basketball hoop set for indoor slam dunks and basketball fun.',
...

    {
      ...
      product_description:
        'A gardening kit with child-friendly tools for little green thumbs.',
...

    {
      ...
      product_description:
        'A pretend play ice cream shop set with scoops, cones, and toppings.',

      img_thumbnail:
        'https://upload.wikimedia.org/wikipedia/commons/2/25/Robert_Patrick.jpg',
...

    {
      ...
      product_description:
        'A pirate ship-themed play tent for swashbuckling adventures.',
...

    {
      ...
      product_description:
        'A set of wooden puzzles for brain-teasing fun and cognitive development.',
...

    {
      ...
      product_description:
        'A science lab playset for young scientists to conduct imaginative experiments.',
      ...
      metadata:
        'science lab playset, young scientists, imaginative experiments',
...

    {
      ...
      product_description:
        'A collection of colorful tropical bird stuffed animals for cuddly companionship.',
...

    {
      ...
      product_description:
        'An educational planetarium model for learning about the solar system.',
...

    {
      ...
      product_description:
        'A set of police car toys for exciting police chase and rescue missions.',
